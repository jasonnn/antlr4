...
class NewTestCodeGenerator {
  ...
  public static
  String generateParserTest(String lexName, String parserName, String startRule) {
    return generateParserTest("", lexName, parserName, startRule);
  }

  public static
  String generateParserTest(String packageName, String lexName, String parserName, String startRule) {
  ...
  public static
  String generateLexerTest(String lexerName) {
    return generateLexerTest("", lexerName);
  }

  public static
  String generateLexerTest(String packageName, String lexerName) {
    String pkgStmnt = (packageName == null || packageName.isEmpty()) ? "" : "package " + packageName + ";\n";
    return pkgStmnt +
           "import org.antlr.v4.runtime.CharStream;\n" +
           "import org.antlr.v4.runtime.Lexer;\n" +
